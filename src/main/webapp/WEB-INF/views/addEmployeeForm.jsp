...
<body>
	...
	<div class=" mx-auto body" style="border: 2px solid black; border-radius: 10px; background-color: white; width: 50%; height: 350px">
		...
		<div class="">
			...
			<form method="POST" action="addEmployeeForm">
