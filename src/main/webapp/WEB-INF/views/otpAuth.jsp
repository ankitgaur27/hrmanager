...
<body>
	...
	<body>
		<div class=" mx-auto mt-5" style="border: 2px solid black; border-radius: 10px; background-color:white; width:40%; height:250px">
            <div class="">
                <div class="text-center mt-3 p-1">
                	<h5><strong>OTP verification</strong></h5>
                    <hr>
                </div>
                <form method ="POST" action="otpAuth" >
                	<c:if test="${(error != null)}"> <p class="text-center text-danger"> <strong>${error}</strong></p></c:if>
	                
	                <div class="p-2 row col-lg-12">
	                	<div class="col-lg-7">
	                		<label for="colFormLabel " class="text col-form-label" >UserName:</label >
	                	</div>
	                	<div class="col-lg-4">
	                		<input
				                type="text"
